...
/**
 * The screen that is shown at the end of the game if you lose.
 * Displays your final score, time, and a button to restart.
 */
public class LoseScreen implements IRenderable {
    private Skin skin;
    ...
    public LoseScreen(){
        ...
        lose = new Label("Better luck next time", skin , "default");
        lose.setFontScale(1.00f);
    ...
    @Override
    public boolean IsActive() { return Game.GetInstance().GetGameState() == GameState.OverLoss; }
